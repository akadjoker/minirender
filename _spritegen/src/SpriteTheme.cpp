...
const char* spriteThemeName(SpriteTheme theme)
{
    switch (theme)
    {
    case SpriteTheme::Dark: return "Dark";
    case SpriteTheme::Light: return "Light";
    case SpriteTheme::Classic: return "Classic";
    case SpriteTheme::Studio: return "Studio";
    }
    return "Dark";
}
...
void applySpriteTheme(SpriteTheme theme)
{
    ...
    switch (theme)
    {
    case SpriteTheme::Dark:
        ImGui::StyleColorsDark();
        break;
    case SpriteTheme::Light:
        ImGui::StyleColorsLight();
        break;
    case SpriteTheme::Classic:
        ImGui::StyleColorsClassic();
        break;
    case SpriteTheme::Studio:
        ImGui::StyleColorsDark();
